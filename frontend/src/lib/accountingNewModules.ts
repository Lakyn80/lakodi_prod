...
export const accountingNewModuleRegistry: AccountingNewModuleRegistryEntry[] = [
  ...
  createRegistryEntry({
    ...
    rag: {
      ...
      searchableFields: [
        ...
        { field: "mimeType", labelKey: "rag.searchableFields.mimeType", weight: 4 },
        { field: "fileSize", labelKey: "rag.searchableFields.fileSize", weight: 3 },
        { field: "attachmentType", labelKey: "rag.searchableFields.attachmentType", weight: 3 },
        { field: "status", labelKey: "rag.searchableFields.status", weight: 3 },
        { field: "checksum", labelKey: "rag.searchableFields.checksum", weight: 2 },
        { field: "note", labelKey: "rag.searchableFields.note", weight: 2 },
        { field: "createdAt", labelKey: "rag.searchableFields.createdAt", weight: 2 },
      ],
    },
  ...
  createRegistryEntry({
    ...
    rag: {
      ...
      searchableFields: [
        { field: "originalFilename", labelKey: "rag.searchableFields.originalFilename", weight: 5 },
        { field: "mimeType", labelKey: "rag.searchableFields.mimeType", weight: 4 },
        { field: "checksum", labelKey: "rag.searchableFields.checksum", weight: 3 },
        { field: "status", labelKey: "rag.searchableFields.status", weight: 3 },
      ],
    },
    voice: {
      labelKey: "voice.labels.attachmentDetail",
  ...
  createRegistryEntry({
    ...
    voice: {
      labelKey: "voice.labels.attachmentInbox",

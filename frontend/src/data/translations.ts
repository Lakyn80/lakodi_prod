  ...
  ua: {
    ...
    accountingNew: {
      ...
      documentWrite: {
        ...
        updateDraft: "Зберегти зміни чернетки",
        ...
        payment: {
          ...
          confirmAction: "Підтвердити платіж",
          success: "Платіж додано.",
          disabledHint: "Платіж не можна додати для цього стану або типу документа.",
          fields: {
            amount: "Сума",
            paidAt: "Дата оплати",
        ...
        validation: {
          ...
          requiredDates: "Заповніть дату видачі та термін оплати.",
          dueBeforeIssue: "Термін оплати не може бути раніше дати видачі.",
        ...
        fields: {
          ...
          subjectNone: "Без суб'єкта — ручний snapshot",
          customerName: "Ім'я / компанія",
          customerEmail: "E-mail",
      ...
      aresWrite: {
        ...
        panelCreateDocument: "Новий документ з цими даними",
        clearSubjectLink: "Заповнити вручну / завантажити з ARES",
        searchResultPendingAddress: "Адресу доповните у формі.",
        searchByName: "Vyhledání firmy podle názvu",
        searchPlaceholder: "Zadejte část názvu firmy",
        searchAction: "Vyhledat",
        searchLoading: "Vyhledávám…",
      ...
      customerPersistence: {
        ...
        existingCustomerReused: "Використано існуючого замовника за IČO.",
        customerAlreadyExists: "Замовник з такими даними вже існує.",
        duplicateCustomerFound: "Знайдено існуючого замовника — дублікат не створено.",
        ambiguousCustomerMatch: "Знайдено {count} збігів — оберіть існуючого замовника.",
        selectExistingCustomer: "Оберіть існуючого замовника зі списку.",
        customerSaveFailed: "Не вдалося зберегти замовника.",
        customerPersistenceRequired: "Перед збереженням документа потрібно зберегти або обрати замовника.",
        aresDuplicateFound: "Компанія з ARES уже є в реєстрі замовників.",
        aresCustomerSaved: "Компанію з ARES збережено як замовника.",
        customerLinkedToDocument: "Документ пов’язано зі збереженим замовником.",
        customerNotSavedWarning: "Документ збережено, але замовника не вдалося записати в реєстр.",
        aresLookupInDocumentForm: "Пошук компанії в ARES у формі документа",
        customerLookupByIco: "Пошук замовника за IČO",
        searchCustomers: "Шукати замовників",
        showCustomers: "Показати замовників",
        hideCustomers: "Сховати замовників",
        customerListCollapsed: "У реєстрі {count} замовників — список згорнуто.",
        tooManyCustomersUseSearch: "Для пошуку використовуйте фільтр — показано лише обмежений вибір.",
        noCustomersFound: "Жоден замовник не відповідає пошуку.",

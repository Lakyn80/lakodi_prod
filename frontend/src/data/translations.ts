    ...
    accountingNew: {
      ...
      moduleRegistry: {
        ...
        reminderEmails: {
          ...
          description: "Metadata pro budoucí frontu a dohled nad upomínkovými e-maily zůstávají připravená bez samostatné UI vrstvy.",
        },
        attachments: {
          label: "Přílohy",
      ...
      voice: {
        ...
        aliases: {
          ...
          reminderEmails: ["upomínkové e-maily", "reminder emaily", "emailové upomínky"],
  ...
  ua: {
    ...
    accountingNew: {
      ...
      moduleRegistry: {
        ...
        reminderEmails: { label: "E-mail нагадування", description: "Metadata для майбутньої черги та контролю e-mail нагадувань залишаються готовими без окремого UI." },
      ...
      voice: {
        ...
        aliases: {
          ...
          reminderEmails: ["e-mail нагадування", "нагадувальні листи", "email reminders"],
  ...
  ru: {
    ...
    accountingNew: {
      ...
      moduleRegistry: {
        ...
        reminderEmails: { label: "Письма-напоминания", description: "Metadata для будущей очереди и контроля писем-напоминаний остаются подготовленными без отдельного UI." },
      ...
      voice: {
        ...
        aliases: {
          ...
          reminderEmails: ["письма-напоминания", "email напоминания", "reminder emails"],
  ...
  en: {
    ...
    accountingNew: {
      ...
      moduleRegistry: {
        ...
        reminderEmails: { label: "Reminder emails", description: "Metadata for a future reminder-email queue and oversight layer remain prepared without a separate UI layer." },
      ...
      voice: {
        ...
        aliases: {
          ...
          reminderEmails: ["reminder emails", "follow-up emails", "dunning emails"],

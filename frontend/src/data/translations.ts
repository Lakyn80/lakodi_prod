  ...
  cs: {
    ...
    accountingNew: {
      ...
      bankWrite: {
        ...
        importSkippedDuplicatesOne: "1 transakce byla přeskočena, protože už byla dříve importována.",
        importSkippedDuplicatesMany: "{count} transakcí bylo přeskočeno, protože už byly dříve importovány.",
        importSkippedIdentifiers: "Přeskočené identifikátory: {items}",
  ...
  ua: {
    ...
    accountingNew: {
      ...
      bankWrite: {
        ...
        importSkippedDuplicatesOne: "1 транзакцію було пропущено, оскільки вона вже була імпортована раніше.",
        importSkippedDuplicatesMany: "{count} транзакцій було пропущено, оскільки вони вже були імпортовані раніше.",
        importSkippedIdentifiers: "Пропущені ідентифікатори: {items}",
  ...
  ru: {
    ...
    accountingNew: {
      ...
      bankWrite: {
        ...
        importSkippedDuplicatesOne: "1 транзакция была пропущена, так как уже была импортирована ранее.",
        importSkippedDuplicatesMany: "{count} транзакций было пропущено, так как они уже были импортированы ранее.",
        importSkippedIdentifiers: "Пропущенные идентификаторы: {items}",
  ...
  en: {
    ...
    accountingNew: {
      ...
      bankWrite: {
        ...
        importSkippedDuplicatesOne: "1 transaction was skipped because it had already been imported.",
        importSkippedDuplicatesMany: "{count} transactions were skipped because they had already been imported.",
        importSkippedIdentifiers: "Skipped identifiers: {items}",
